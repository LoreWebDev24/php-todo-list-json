        ...
        <div id="app">
            ...
            <div class="container">
                <div class="tasks-wrapper">
                    <h3>Your Tasks:</h3>
                    <ol>
                        <li :class="{done: todo.done}" @click="taskStatus(i)"v-for="(todo, i) in todos" :key="i">{{ todo.text }}   
                            <span class="task-remover" @click.stop="removeTask(i)"><i class="remove-icon fa-solid fa-x"></i></span>
                        </li>
                    </ol>
                </div>
            </div>
